A Python implementation of HQ9+ language and its object-oriented extension, HQ9++. The language is known for its very simple and clear syntax. The available commands are:
